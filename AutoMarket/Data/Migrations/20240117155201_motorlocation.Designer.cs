...
namespace AutoMarket.Data.Migrations
{
    ...
    [Migration("20240117155201_motorlocation")]
    partial class motorlocation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoMarket.Models.Truck", b =>
                {
                    ...
                    b.Property<int>("TruckColorId")
                        .HasColumnType("int");

                    b.Property<int>("TruckConditionId")
                        .HasColumnType("int");

                    b.Property<int>("TruckFuelTypeId")
                        .HasColumnType("int");

                    b.Property<int>("TruckLoadCapacity")
                        .HasColumnType("int");

                    b.Property<int>("TruckMileageId")
                        .HasColumnType("int");

                    b.Property<int>("TruckModelId")
                        .HasColumnType("int");

                    b.Property<int>("TruckTransmissionTypeId")
                        .HasColumnType("int");

                    b.Property<int>("TruckVersionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TruckColorId");

                    b.HasIndex("TruckConditionId");

                    b.HasIndex("TruckFuelTypeId");

                    b.HasIndex("TruckMileageId");

                    b.HasIndex("TruckModelId");

                    b.HasIndex("TruckTransmissionTypeId");

                    b.HasIndex("TruckVersionId");
            ...
            modelBuilder.Entity("AutoMarket.Models.TruckBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TruckBrands");
                });

            modelBuilder.Entity("AutoMarket.Models.TruckColor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoMarket.Models.TruckCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TruckConditions");
                });

            modelBuilder.Entity("AutoMarket.Models.TruckFuelType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TruckFuelTypes");
                });

            modelBuilder.Entity("AutoMarket.Models.TruckMileage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TruckMileages");
                });

            modelBuilder.Entity("AutoMarket.Models.TruckModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoMarket.Models.TruckPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoMarket.Models.TruckTransmissionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TruckTransmissionTypes");
                });

            modelBuilder.Entity("AutoMarket.Models.TruckVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoMarket.Models.Truck", b =>
                {
                    b.HasOne("AutoMarket.Models.TruckBrand", "TruckBrand")
                        .WithMany()
                        .HasForeignKey("TruckBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoMarket.Models.TruckColor", "TruckColor")
                        .WithMany()
                        .HasForeignKey("TruckColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoMarket.Models.TruckCondition", "TruckCondition")
                        .WithMany()
                        .HasForeignKey("TruckConditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoMarket.Models.TruckFuelType", "TruckFuelType")
                        .WithMany()
                        .HasForeignKey("TruckFuelTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoMarket.Models.TruckMileage", "TruckMileage")
                        .WithMany()
                        .HasForeignKey("TruckMileageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoMarket.Models.TruckModel", "TruckModel")
                        .WithMany()
                        .HasForeignKey("TruckModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoMarket.Models.TruckTransmissionType", "TruckTransmissionType")
                        .WithMany()
                        .HasForeignKey("TruckTransmissionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoMarket.Models.TruckVersion", "TruckVersion")
                        .WithMany()
                        .HasForeignKey("TruckVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("TruckColor");

                    b.Navigation("TruckCondition");

                    b.Navigation("TruckFuelType");

                    b.Navigation("TruckMileage");

                    b.Navigation("TruckModel");

                    b.Navigation("TruckTransmissionType");

                    b.Navigation("TruckVersion");
            ...
            modelBuilder.Entity("AutoMarket.Models.TruckPhoto", b =>
                {
                    b.HasOne("AutoMarket.Models.Truck", "Truck")
                        .WithMany("TruckPhotos")
